		...
		<div class="nav-step">
			...
			<div class="middle">
				...
				<div 
					...
					class="page-title header colour-fill-pop anim-6">
...
:root{
	...
	#navbar .middle .page-logo, #navbar .middle .page-title {
	...
	#navbar .middle .page-logo.is-active, #navbar .middle .page-title.is-active {
